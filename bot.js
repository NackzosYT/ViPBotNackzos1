...
client.on('message', message => {
    ...
    .setDescription(`
    أمثله على الأوامر : 
    v!role @mention rolename : لأعطاء رتبة لعضو معين
    v!role all rolename : لأعطاء رتبة للجميع 
    v!role humans rolename : لأعطاء رتبة للاشخاص فقط
    v!role bots rolename : لأعطاء رتبة لجميع البوتات`)
    .setFooter('Requested by '+message.author.username, message.author.avatarURL)
  message.channel.sendEmbed(role)
    }})
    
  client.on('message', message => {
    if(message.content.startsWith(prefix + 'v!-role')) {
        if(!message.member.hasPermission('MANAGE_ROLES')) return
      let role = new Discord.RichEmbed()
    .setDescription(`
    أمثله على الأوامر : 
    v!-role @mention rolename : لسحب رتبة لعضو معين
    v!-role all rolename : لسحب رتبة للجميع 
    v!-role humans rolename : لسحب رتبة للاشخاص فقط
    v!-role bots rolename : لسحب رتبة لجميع البوتات`)
    .setFooter('Requested by '+message.author.username, message.author.avatarURL)
  message.channel.sendEmbed(role)
    }})
...
client.on("message", message => {
    if (message.content === "V!support") {
     ...
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
         .addField('سيرفر الدعم الفني', `https://discord.gg/drcrDZ`)
...
client.on('message', async message => {
    ...
    let args = message.content.split(' ').slice(1);
if (message.content.startsWith("v!deletecolors")) {
...
client.on("message", (message) => {
  ...
  if(message.content.startsWith(`${prefix}close`)){
     ...
     message.channel.send(`Are you sure? Once confirmed, you cannot reverse this action!\nTo confirm, type \`v!close`. This will time out in 10 seconds and be cancelled.`)
         .then((m) => {
             message.channel.awaitMessages(response => response.content === 'v!close', {
                     max: 1,
                     time: 10000,
                     errors: ['time'],
                 })
...
client.on('ready', () => {
  ...
  console.log('╚[════════════]╝')
  console.log('')
client.user.setGame(`v!help | ViPBot`,"http://twitch.tv/ViPBot")
});
...
client.on('message', message => {
if (message.content.startsWith("v!tr")) {
...
client.on('message', message => {
let args = message.content.split(' ').slice(1);
if(message.content.split(' ')[0] == 'v!color'){
...
client.on('message', message => {
if (message.content.startsWith("v!botinfo")) {
message.channel.send({
embed: new Discord.RichEmbed()
   .setAuthor(client.user.username,client.user.avatarURL)
   .setThumbnail(client.user.avatarURL)
   .setColor('RANDOM')
   .setTitle('``INFO  Blood System`` ')
...
client.on('message', message => {
if(message.content.startsWith("v!slots")) {
let slot1 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
let slot2 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
let slot3 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
...
client.on('message', message => {
if(message.content.startsWith("v!حجرة")) {
...
client.on('message', message => {
if(message.content.startsWith("v!ورقة")) {
let slot1 = ['✂ورقة📄', '🗿حجرة🗿', '✂مقص📄'];
let slots1 = `${slot1[Math.floor(Math.random() * slot1.length)]}`;
let we;
if(slots1) {
...
client.on('message', message => {
if(message.content.startsWith("v!مقص")) {
let slot1 = ['✂ورقة📄', '🗿حجرة🗿', '✂مقص📄'];
let slots1 = `${slot1[Math.floor(Math.random() * slot1.length)]}`;
let we;
if(slots1) {
...
❯ ${prefix}image → Shows Server Avatar
...
**        `)
          ...
          client.on("message", message => {
            if (message.content === "Bmembercount") {
...
❯ ${prefix}play → To play the song in the voice room
❯ ${prefix}stop → To stop the song
❯ ${prefix}skip → To skip the song
❯ ${prefix}queue → View the waiting list
...
const TOKEN = "NDcwOTY2NDgyOTQwMTk4OTEy.DsbS7g.ZV8E9zVQpZOttwbBxZy4ImGwAR4";
...
client.on("message", (message) => {
if (message.content.startsWith("v!setchannel")) {
        let args = message.content.split(" ").slice(1);
...
client.on("message", (message) => {
if (message.content.startsWith("v!setvoice")) {
        let args = message.content.split(" ").slice(1);
  ...
  await  message.channel.send(`🔔 **| اكتب اقتراحك **`)
    ...
    message.delete(10000);
       ...
       .setFooter(message.author.username, message.author.avatarURL)
              ...
              client.channels.find('name', 'suggestion').send({embed})
       .setFooter(message.author.username, message.author.avatarURL)
...
const Za7f = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("v!عقاب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL)
...
.addField('اذا ما شتغل الرابط يعني الايدي يلي كتبته غلط', `Blood System`)
message.channel.sendEmbed(idembed)
 ...
 client.on('message', message => {
   if (message.content.startsWith("v!كت تويت")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL)
...
const secreT = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("v!خواطر")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
